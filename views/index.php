...
<header>
    ...
    <nav class="navbar navbar-light navbar-expand-lg sticky-top" style="background-color: dodgerblue">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-left col" href="#">
                <img src="/resource/assets/PcWXuuG.png" height="150" class="d-inline-block align-top" alt="">
            </a>
