    ...
    <nav class="navbar navbar-light navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-left col" href="#">
                <div class="d-none">
                    <img src="/resource/assets/logo.png" height="256" width="256" style="padding-top: 100px"
                         class="d-md-none d-lg-block" alt="">
                </div>
                <div class="d-sm-block d-md-block">
                    <img src="/resource/assets/logo.png" height="64" width="64" style="padding-top: 100px"
                         class="d-sm-block d-md-block" alt="">
                </div>
            </a>
